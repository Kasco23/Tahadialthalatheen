...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'tunnel-gradient': 'radial-gradient(ellipse at center, rgba(31, 41, 55, 0.8) 0%, rgba(0, 0, 0, 0.95) 70%)',
        'champions-tunnel': 'radial-gradient(ellipse at bottom center, rgba(10, 27, 81, 0.9) 0%, rgba(5, 15, 40, 0.95) 50%, rgba(0, 0, 0, 1) 100%)',
        'stadium-spotlight': 'radial-gradient(circle at bottom center, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.2) 30%, transparent 70%)',
