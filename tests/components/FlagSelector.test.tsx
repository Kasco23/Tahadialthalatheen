...
vi.mock('react-country-flag', () => ({
  default: ({ countryCode, title, ...props }: { countryCode: string; title?: string; [key: string]: any }) => (
...
describe('LogoSelector Component', () => {
  ...
  it('filters teams based on search', async () => {
    ...
    await waitFor(() => {
      const searchInput = screen.getByPlaceholderText('Search teams or leagues...');
